...
public class DocumentManagerImplTest extends AbstractCoreTCase {
	...
	public void testCreate() throws Exception {
		User user = userDao.findByUserName("admin");
		Document doc = docDao.findById(3375108L);
		
//		SearchEngine indexer = (SearchEngine) Context.getInstance().getBean(SearchEngine.class);
//
//		String content = indexer.getHit(doc.getId()).getContent();
		...
		transaction.setNotified(0);
		transaction.setComment("pippo_reason");
		doc.setCustomId("YYYYYYYYYYYYYYY1");

		Document newDoc = documentManager.create(new FileInputStream("E:/EclipseWorkSpace/.metadata/.plugins/org.eclipse.wst.server.core/tmp1/wtpwebapps/Logicaldoc_web/images/pom.xml"), doc, transaction);
